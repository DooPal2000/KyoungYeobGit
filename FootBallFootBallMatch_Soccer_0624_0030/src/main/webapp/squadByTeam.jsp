...
<body>
	...
	<div class="container px-3 mt-3" id="teamCodeBox">
		<br>
		<h1 class="display-6">🏆 이 페이지는 '팀 코드' 입력 후 스쿼드를 확인하는 페이지입니다.</h1>
		<br>
		<h5>🏆 팀 코드는 '순위' 탭에서 가져올 수 있습니다.</h5>


		<div class="row align-items-stretch">
			<div class="col-8 mt-3">
				<div class="form-floating">
					<input type="text" class="form-control" id="teamCodeInput"
						placeholder="일정 코드 입력"> <label for="teamCodeInput">팀
						코드</label>
				</div>
			</div>
			<div class="col-4 mt-3">
				<button type="submit" id="teamCodeBtn"
					class="btn btn-outline-primary btn-lg">팀 코드 입력하기</button>
			</div>
		</div>
	</div>
	...
	<script src="squadByTeam.js"></script>
	<!-- BOOTSTRAP JS_CODE -->
	<script
