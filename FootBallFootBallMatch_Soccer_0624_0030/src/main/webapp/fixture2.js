...
function renderFixtures(fixtures) {
    ...
    fixtures.forEach((fixture) => {
        ...
        const predictBtn02 = document.createElement('button');
		predictBtn02.textContent = '승부예측';
		predictBtn02.classList.add('btn');
		predictBtn02.classList.add('btn-outline-dark');
		predictButtonCell.appendChild(predictBtn02);
		...
		predictBtn02.id = `predictBtn_${fixtureCode}`;
		predictBtn02.dataset.fixtureCode = fixtureCode;
